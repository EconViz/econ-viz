...
![Cobb-Douglas indifference map with budget line and equilibrium point](examples/output/cobb_douglas_eq.png)
...
![Cobb-Douglas indifference curves](examples/output/cobb_douglas.png)
...
![Leontief indifference curves](examples/output/leontief_eq.png)
...
![Perfect substitutes indifference curves](examples/output/perfect_substitutes_eq.png)
...
![CES indifference curves](examples/output/ces_eq.png)
...
![Satiation indifference curves](examples/output/satiation.png)
...
![Quasi-linear indifference curves](examples/output/quasi_linear.png)
...
![Parsed Cobb-Douglas from LaTeX](examples/output/latex_cobb_douglas_u.png)
...
![Custom utility indifference map](examples/output/advanced_custom.png)
...
![Multi-good Cobb-Douglas frozen slice](examples/output/advanced_multigd.png)
...
| Default | Nord |
|---------|------|
| ![Default theme](examples/output/theme_default.png) | ![Nord theme](examples/output/theme_nord.png) |
