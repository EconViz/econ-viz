...
_ATTR_EXPORTS = {
    ...
    "Stroke": ("econ_viz.themes.stroke", "Stroke"),
    "Axis": ("econ_viz.themes.axis", "Axis"),
    "Config": ("econ_viz.config", "Config"),
    "Fill": ("econ_viz.themes.fill", "Fill"),
    "Label": ("econ_viz.themes.label", "Label"),
    "Legend": ("econ_viz.themes.legend", "Legend"),
    "Marker": ("econ_viz.themes.marker", "Marker"),
    "Effect": ("econ_viz.canvas.effect", "Effect"),
